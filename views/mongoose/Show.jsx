          ...
          <>
            ...
            {props.flight.destinations.map((item, index) =>
              <div className="container" key={index}>
                ...
                <form className="destination-Btn"  action={`/mongoose/${props.flight._id}/destinations/${item._id}`}>
                  <button>Edit Destination</button>
                </form>
                <br/>
                <form className="destination-Btn"  action={`/mongoose/${props.flight._id}/destinations/${item._id}?_method=DELETE`} method="POST">
